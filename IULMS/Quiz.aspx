<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Quiz.aspx.cs" Inherits="IULMS.Quiz" %>
            ...
            <script>
                ...
                function Decrement() {
                    ...
                    if (secs !== -1) {
                        ...
                        window.location.href = "Quiz.aspx?timeout=1"
                    }
                }
                ...
                function CheckIfAllQuestionAnswerHasBeenSubmitted() {
                    ...
                    if (parseInt(flagtocheckcount) == parseInt(numItems)) {
                        ...
                        $("#lbresult").text("Final Result-:" + CountFinalResult + "/60");
